    ...
    return <footer className="bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
            ...
            <div className="flex justify-center">
                <span className="text-sm text-gray-500 text-center dark:text-gray-400">© 2024 Tweetify | Made with ❤️ by <a href="https://composio.dev" className="hover:underline" target="_blank" rel="noopener noreferrer">Composio</a></span>
            </div>
        </div>
    </footer>
